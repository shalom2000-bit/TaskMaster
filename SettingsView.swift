...
// Edited by Vishaliny Sriragunathan (Student ID: 101429635) on 2025-03-20 - Reviewed and added comment to My Account section
...
            
            // My Account
            // Reviewed by Vishaliny Sriragunathan - Added placeholder email for profile
            Section(header: Text("My Account")) {
                NavigationLink("Profile") {
                    Text("Profile Details\nName: Vishaliny Sriragunathan\nEmail: vishaliny101429635@school.com")
